...
#if os.path.isfile('/home/franco/backup20230116.zip'):
...
#Datos FTP
ftp_servidor = 'pejemofe.es'
ftp_usuario  = 'alberto_virtual'
ftp_clave    = 'usuario'
ftp_raiz     = '/'

# Datos del fichero a subir
fichero_origen = f'/home/franco/{nombre_archivo}'
...
import smtplib
remitente = "fjcanizares19@ieszaidinvergeles.org"
destinatario = "javic.c2001n@gmail.com"
